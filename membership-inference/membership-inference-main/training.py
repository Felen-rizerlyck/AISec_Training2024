...
target_model.fit(*target_train_set, epochs=200, callbacks=t_cbs, batch_size=args.batch_size, verbose=2)
source_model.fit(*source_train_set, epochs=200, callbacks=s_cbs, batch_size=args.batch_size, verbose=2)
